...
const initMessages =
  [
    { role: "user", content: "Hey there! I'm setting up a Markdown Zettelkasten Assistant for my sidebar. Let me give you some context:\n\nZettelkasten is a note-taking method where each note is a standalone idea, linked to others through references or tags. I prefer structuring notes in a specific way to maintain consistency and clarity. Each note should include a title, date of creation, relevant tags, and concise content. Here's an example of how I prefer notes to be structured:\n\n---\ntitle: Atomic Notes Roadmap v1\nup: \"[[atomic-notes]]\"\ndate: 20240501082615\ntags:\n  - atomic-notes\n  - roadmaps\n  - features\n---\n\n## 🎯 Version 1.0 Objectives\n\n- New Features\n  - [[Templates]]: Allows creating notes quickly into various formats.\n  - [[Config]]: Global configuration for consistent systems.\n  - [[Zettelkasten Note]]: Organizes and structures note handling.\n  - ...\n\nFeel free to ask for assistance or guidance on creating and organizing notes!" },
    { role: "assistant", content: "- Got it!" },
    { role: "user", content: "Here's another example note:\n\n---\ntitle: Arch Linux Mirrorlists\ndate: 20240501134902\ntags:\n  - linux\n  - notes\n  - download-speeds\n---\n\n## Content\n\nArch Extras includes a script to test for testing mirrors...\n\nFeel free to ask for further assistance or any questions!" },
    { role: "assistant", content: "- Got it!" }
  ];
